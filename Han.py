...
dict_type = {tech:['Laptops', 'Hard Drives', 'Phones', 'Microwaves', 'Headphones', 'Electronic Locks', 'Drones', 'Computers', 'Tablets', 'TVs', 'Remotes', 'Earbuds',
                'Smart fridges', 'Mouse', 'Webcam', 'USB', 'Cables'], clothes:['Jeans', 'Underwear', 'Shoes', 'Sandals', 'Formal Wear', 'Socks', 'Swimwear', 'Kahkis', 
                'Gowns', 'Dresses', 'T-shirts', 'Glasses', 'Sunglasses'], furniture:['Chairs', 'Couches', 'Recliners', 'Tables', 'Cabinets', 'Clocks', 'Bookcase', 'Dresser', 
